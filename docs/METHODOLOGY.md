...
| Suitability = 100 at | **5.0 tCO₂/ha/yr** (was the stoichiometric maximum, 8.69–8.85, until 2026-09-02) | an absolute value with a physical reading: about the most a metre of drainage carries at calcite saturation, the ceiling's own top on real cropland (capped maximum 4.92 on the 2026-09-01 build). The stoichiometric top became unreachable once the ceiling shipped: 0.04% of area scored ≥ 80 and nothing ≥ 85. Middle knots respaced log-evenly (20 = 0.1, 40 = 0.4, 60 = 1.0, 80 = 2.5). Not a build quantile, so it does not drift |
