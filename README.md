...
| No paddy mask, so the headline paddy prediction could not appear at all | **Soil pCO₂ interpolated continuously** from flooded fraction of cell-time: GRPI inundation months × SPAM all-technology rice sub-cell area (all rice since 2026-08-24: irrigated-only zeroed the rainfed lowland paddies of central/eastern India and SE Asia). 10.3% of cropland area has >5% flooded cell-time |
